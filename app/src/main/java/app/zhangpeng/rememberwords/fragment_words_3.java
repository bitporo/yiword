...
/**
 * Created by zhangpeng on 2019-09-08.
 */
public class fragment_words_3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_words_3, container, false);
        text_words=new int[]{R.id.textView80,R.id.textView81,R.id.textView82,R.id.textView83,R.id.textView84
                ,R.id.textView85,R.id.textView86,R.id.textView87,R.id.textView88,R.id.textView89};
        text_voice=new int[]{R.id.textView90,R.id.textView91,R.id.textView92,R.id.textView93,R.id.textView94
                ,R.id.textView95,R.id.textView96,R.id.textView97,R.id.textView98,R.id.textView99};
        text_mean=new int[]{R.id.textView100,R.id.textView101,R.id.textView102,R.id.textView103,R.id.textView104
                ,R.id.textView105,R.id.textView106,R.id.textView107,R.id.textView108,R.id.textView109};
        ...
        cursor.moveToPosition((preferences.getInt("days",1)-1)*40+20);//天数*40//第一个fragment
